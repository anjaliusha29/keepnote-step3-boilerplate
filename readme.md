...
1. Clone the base boilerplate in the folder **assignment-solution-step3** of your local machine
    ...
    `git clone https://gitlab-ust.stackroute.in/stack_java_keep/KeepNote-Step3-Boilerplate.git assignment-solution-step3`
...
5. Add your new repository reference as remote
     ...
     `git remote add origin https://gitlab-ust.stackroute.in/{{yourUserName}}/assignment-solution-step3.git`
